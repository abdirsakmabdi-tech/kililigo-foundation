...
import type { ActionResult } from '@/app/admin/_actions/hero'
...
export default function HeroSlideForm({ initial, action, submitLabel }: Props) {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-5 rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
      <FileUploadField
        ...
        hint="Max 2 MB. Used in the homepage hero slideshow."
      />
