...
export default function HeroIntro({ content }: { content: HeroIntroContent }) {
  const intro = content.introText || FALLBACK_INTRO
  const words = intro.split(' ')
  const backgroundUrl = content.backgroundUrl || '/hero-intro-bg.png'
  ...
  return (
    <section className="relative py-14 md:py-24 overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <img src={backgroundUrl} alt="" className="absolute inset-0 w-full h-full object-cover" aria-hidden />
