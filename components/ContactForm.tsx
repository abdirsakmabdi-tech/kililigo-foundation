...
export default function ContactForm({ details }: { details: ContactDetails }) {
  ...
  const locationLines = details.locationText.split(/\n+/).map((line) => line.trim()).filter(Boolean)
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 md:py-24">
        ...
        <div className="mt-10 pt-8 border-t border-gray-400/40 grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-gray-700 font-medium text-sm font-sans">
          ...
          <div>
            ...
            <a
              ...
              className="text-gray-700 font-medium text-sm font-sans hover:text-primary transition-colors"
            >
              {details.email}
            </a>
          </div>
