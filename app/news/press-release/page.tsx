...
export const metadata: Metadata = {
  title: 'Press Release | Kililigo Foundation',
  description: 'Official press releases and announcements from Kililigo Foundation.',
}
    ...
    <div className="pt-16 md:pt-20 bg-white">
      ...
      <div className="relative bg-secondary pb-0 pt-16 md:pt-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20 md:pb-28">
          <p className="text-white/60 text-sm font-sans uppercase tracking-widest mb-4">News</p>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white font-sans">Press Release</h1>
        </div>
      ...
      <div className="bg-white py-24 md:py-32">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 font-sans">
            Our press releases and official announcements will be available here soon.
          </p>
        </div>
      </div>
    </div>
